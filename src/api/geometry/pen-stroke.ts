...
class PenStroke {
  ...
  getStrokeList(): Array<PenPoint> | null {
  ...
  addPoint(point: PenPoint): void {
    ...
    if (pSize > 1) {
      if (pSize > 2) {
        // Keep track only of the two last observed points.
        this.points.shift()
      }
  ...
  intersects(rect: Rectangle): boolean {
    ...
    return this.intersectsRect(this.B, rect)
  }
